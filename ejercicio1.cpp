/*Descripci?n de problema:  Escribir una funci?n Salario que calcule los salarios de un trabajador 
para un n?mero dado de horas trabajadas y un salario hora. Las horas que superen las 40 horas semanales 
se pagar?n como extras con un salario hora 1,5 veces el salario ordinario. As? mismo se deber? calcular el monto 
